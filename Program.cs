...
namespace VerificacionISBN
{
    class Program
    {
        ...
        {
            int resp;
            Console.WriteLine("Formato ISBN a verificar:");
            ...
            switch (resp)
            {
                case (1):
                    ...
                    Console.WriteLine("ISBN formato 10\n");
                    ...
                    {
                        Console.WriteLine("ISBN validado");
                    }
                    Console.ReadKey();
                    break;
                ...
                case (2):
                    ...
                    Console.WriteLine("ISBN formato 13");
